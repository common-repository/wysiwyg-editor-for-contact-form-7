    ...
    <fieldset>
	  ...
	  <table class="form-table">
        <tbody>
		  ...
		  <tr>
			<th scope="row"><?php _e('Media Button', 'cf7-wysiwyg'); ?></th>
			<td>
			  <fieldset>
			    <legend class="screen-reader-text"><?php _e('Media Button', 'cf7-wysiwyg'); ?></legend>
				<label>
				  <input type="checkbox" name="mediaButton" class="option" value="1">
				  <?php _e('Add a media button', 'cf7-wysiwyg'); ?>
				</label>
			  </fieldset>
			</td>
		  </tr>
